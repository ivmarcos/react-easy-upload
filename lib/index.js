...
var ReactUpload = function (_PureComponent) {
  ...
  function ReactUpload(props) {
    ...
    var _this = _possibleConstructorReturn(this, (ReactUpload.__proto__ || Object.getPrototypeOf(ReactUpload)).call(this, props));
  ...
  _createClass(ReactUpload, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['children', 'onUpload']);
      ...
      return _react2.default.createElement(
        ...
        children({ requestUpload: this.requestUpload, files: files })
      );
    }
  }]);
